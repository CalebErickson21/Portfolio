...
const Experience = () => {
    ...
    return (
        <div className={`flex flex-col w-full h-full`}>
            {/* Header */}
            <div className={`flex flex-col justify-center items-center text-center w-full h-full px-8 py-4 ${light ? "bg-gradient-to-br from-light-bg-primary to-accent" : "bg-gradient-to-br from-dark-bg-primary to-accent"} transition duration-300 ease-in-out`}>
            ...
            <div className={`flex flex-col w-full h-full ${light ? "bg-gradient-to-bl from-accent to-light-bg-primary" : "bg-gradient-to-bl from-accent to-dark-bg-primary"} transition duration-300 ease-in-out`}>
