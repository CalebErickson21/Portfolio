    ...
    const publicationsData = [
        {
            ...
            authors:
                "Shenglin Li, Caleb Erickson, Michal Zajac, Xiaoming Guo, Qiuhua Duan, Jiaqi Gong",
            description:
                "Introduces a semi-automated human-in-the-loop ontology engineering method combining expert schemas and LLM-driven refinement, then demonstrates how the resulting ontology can translate flood-data into actionable alerts (e.g., tailored advice for vulnerable populations).",
            venue: "MDPI - Water",
            year: "2025",
        ...
        },
        {
            ...
            authors:
                "Michal Zajac, Connor Kulawiak, Shenglin Li, Caleb Erickson, Nathan Hubbell, Jiaqi Gong",
            description:
                "Examines how fragmented flood information and information-overload hinder community leaders; proposes an AI-driven platform using knowledge graphs + retrieval-augmented generation to produce context-aware narratives (infographics, maps, cost/benefit) for flood-risk communication.",
                ...
                <div className="min-h-screen flex flex-col flex-1 items-center justify-center pt-2 pb-4">
                    <div className="flex flex-1 flex-col w-5/6 my-4 mx-2 items-center justify-center text-center">
                        ...
                        <h5 className="text-md mb-3 font-semibold text-light-text-primary dark:text-dark-text-primary">
                            I am actively engaged in research within the fields
                            of artificial intelligence and machine learning,
                            with a focus on developing innovative approaches to
                            complex real-world problems. My current and
                            forthcoming publications are associated with the
                            Alabama Institute for the Advancement of Artificial
                            Intelligence, reflecting collaborative work at the
                            intersection of AI, knowledge systems, and applied
                            data science.
                        </h5>
                    </div>
                </div>
