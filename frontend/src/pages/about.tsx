                ...
                <div className="min-h-screen flex flex-col flex-1 items-center justify-center pt-2 pb-4">
                    <div className="flex flex-1 flex-col w-5/6 my-4 mx-2 items-center justify-center text-center">
                        ...
                        <h5 className="text-md mb-3 font-semibold text-light-text-primary dark:text-dark-text-primary">
                            When I am not focused on academics or professional
                            projects, I make it a priority to stay active and
                            engaged with the people and activities that keep me
                            balanced. I grew up playing football and basketball,
                            and while I no longer compete for a school team, I
                            now play for my fraternity’s intramural basketball
                            team and join pickup games with friends whenever I
                            can. Beyond that, I work out at the gym almost every
                            day, seeing exercise as both a discipline and a way
                            to recharge.
                        </h5>

                        <h5 className="text-md mb-3 font-semibold text-light-text-primary dark:text-dark-text-primary">
                            Family and relationships also play a central role in
                            my life. As one of six siblings, I value staying
                            connected with my three brothers and two sisters,
                            even while away at Alabama. Regularly keeping in
                            touch with friends and family helps me maintain
                            perspective and reminds me of the strong support
                            system behind me.
                        </h5>

                        <h5 className="text-md mb-3 font-semibold text-light-text-primary dark:text-dark-text-primary">
                            I also enjoy exploring new experiences and places.
                            Traveling has become a way to satisfy my curiosity,
                            and I’m always eager to try something different.
                            This winter, I hope to learn snowboarding as my next
                            adventure. At the same time, I balance my active
                            lifestyle with quieter moments, whether it’s playing
                            acoustic guitar or winding down with a movie. These
                            hobbies reflect my drive to stay curious, creative,
                            and connected, both inside and outside the
                            classroom.
                        </h5>
                    </div>
                </div>
