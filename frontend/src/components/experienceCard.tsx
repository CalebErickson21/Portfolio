...
const ExperienceCard = ({
    ...
    return (
        <div
            ...
            shadow-md hover:shadow-lg hover:shadow-accent
        ...
        >
            ...
            >
                ...
                {/* Image */}
                <div
                    className={`flex w-full h-full ${expandedCard === id ? "h-[25dvh]" : "h-[15dvh]"} items-center justify-start mb-2 p-0`}
                >
                    <img
                        src={image}
                        alt={title}
                        className="w-full h-full object-cover rounded-lg m-0 p-0"
                    />
                </div>
